...
class ThaiQAExample(object):
    """
    A single training/test example for the Thai QA dataset.
    """
...
def write_predictions(all_examples, all_features, all_results, n_best_size,
                      ...
                      verbose_logging, null_score_diff_threshold, tokenizer):
